"""
Django settings for mydiaryproject project.
...
SECRET_KEY = 'django-insecure-fucd)@$#dq@6-!)r+&ir)p6jkktdrezo-f-cr)af17pu@skh+^'
...
ROOT_URLCONF = 'mydiaryproject.urls'
...
WSGI_APPLICATION = 'mydiaryproject.wsgi.application'
